					...
					<div>
						...
						<ul className="space-y-4">
							<li className="flex items-start">
								...
								<span className="text-slate-400 font-secondary">
									Decorkaro, Sai Baba Mandir, Behind Pipeline road, Kalher, Thane, India,
									421302
								</span>
							</li>
							<li className="flex items-center">
								...
								<a
									...
									className="text-slate-400 hover:text-yellow-500 transition-colors font-secondary"
								>
									+91 99308 45311
								</a>
							</li>
