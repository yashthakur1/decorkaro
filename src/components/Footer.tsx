        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-white/70 mb-6">
              Premium interior design services that transform spaces into 
              aesthetically pleasing and functional environments.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/about" className="text-white/70 hover:text-white inline-flex items-center">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  <span>About Us</span>
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-white/70 hover:text-white inline-flex items-center">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  <span>Our Services</span>
                </Link>
              </li>
              <li>
                <Link to="/projects" className="text-white/70 hover:text-white inline-flex items-center">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  <span>Recent Projects</span>
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white/70 hover:text-white inline-flex items-center">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  <span>Contact Us</span>
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-white/70 hover:text-white inline-flex items-center">
                  <ChevronRight className="w-4 h-4 mr-2" />
                  <span>FAQ</span>
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex">
                <MapPin className="w-5 h-5 text-white/70 mr-3 mt-1 flex-shrink-0" />
              ...
              <li className="flex">
                <Phone className="w-5 h-5 text-white/70 mr-3 mt-1 flex-shrink-0" />
