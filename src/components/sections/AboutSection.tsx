          ...
          <div>
            ...
            >
              ...
              <p className="text-slate-700 mb-8 font-secondary">
                Our team of expert designers brings a perfect blend of creativity, technical knowledge, and market trends 
                to deliver personalized design solutions that reflect your style, needs, and aspirations.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div className="flex items-start">
                  <CheckCircle className="text-yellow-500 mr-3 flex-shrink-0 mt-1" size={20} />
                  <p className="text-slate-700 font-secondary">Expert Design Consultations</p>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="text-yellow-500 mr-3 flex-shrink-0 mt-1" size={20} />
                  <p className="text-slate-700 font-secondary">Project Management Excellence</p>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="text-yellow-500 mr-3 flex-shrink-0 mt-1" size={20} />
                  <p className="text-slate-700 font-secondary">Customized Interior Solutions</p>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="text-yellow-500 mr-3 flex-shrink-0 mt-1" size={20} />
                  <p className="text-slate-700 font-secondary">Timely Delivery & Transparency</p>
                </div>
              </div>
