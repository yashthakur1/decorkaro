...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto section-padding md:max-w-5xl relative z-10">
        <div className="max-w-3xl text-white">
          <motion.div
            className="overflow-hidden inline-block mb-3"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <motion.span
              ...
              initial="hidden"
              animate={isVisible ? "visible" : "hidden"}
              className="subtitle text-white/80 inline-block"
            >
          ...
          <div className="overflow-hidden mb-6">
            <motion.h1
              ...
              initial="hidden"
              animate={isVisible ? "visible" : "hidden"}
              className="font-display text-5xl md:text-7xl font-semibold text-balance"
            >
          ...
          >
            ...
            <Button asChild variant="outline" size="lg" className="text-md px-8 py-6 bg-transparent border-white text-white hover:bg-white/10">
